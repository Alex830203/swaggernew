            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <!-- <a class="dropdown-item" href="faq.html" onclick="window.location.reload();">FAQ</a> -->
                        ...
                        <a class="dropdown-item" href="https://drive.google.com/drive/u/1/folders/1RhZ5g1qgIJnHmygk8D_-zbJyPxOVRiZr" onclick="window.open();">下载区</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <!-- <a class="dropdown-item" href="faq.html" onclick="window.location.reload();">FAQ</a> -->
                        ...
                        <a class="dropdown-item" href="https://drive.google.com/drive/u/1/folders/1RhZ5g1qgIJnHmygk8D_-zbJyPxOVRiZr" onclick="window.open();">Download</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
